...
function PrinterTableData()
{
   ...
   <div style='position: relative;font-family: Arial; color:black'>
        ...
        <p style=" font-size: 0.15px;  margin-top:0.5px ;width:2px; margin-left:4.3px; position: absolute ">${tableSelectedRows[0].VehicleBrandName} - ${tableSelectedRows[0].Vehiclemodel}(${tableSelectedRows[0].vehicltype})</p>
        <p style=" font-size: 0.15px;  margin-top:1.3px ;width:5px; margin-left:4.3px; position: absolute ">${tableSelectedRows[0].modelyear} - ${numberToWords(number)}</p>
